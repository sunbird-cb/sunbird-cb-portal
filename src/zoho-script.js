...
function setAllDependancyFieldsMapping() {
    ...
    if (mapDependancyLabels) {
        for (var i = 0; i < mapDependancyLabels.length; i++) {
            ...
            var obj = document.forms['zsWebToCase_120349000004451166'][label];
            if (obj) {
...
function getMapDependenySelectValues(module, key) {
  if(jQuery("[id='dependent_field_values_" + module + "']").val()) {
    ...
    if (val != null && val != "" && val != "null" && mySelObject) {
        ...
        for (var i in fields) {
            if (fields.hasOwnProperty(i)) {
                ...
                var depObj = document.forms['zsWebToCase_120349000004451166'][label];
...
var zsWebFormMandatoryFields = new Array("Contact Name", "Email", "Subject", "Categories");
var zsFieldsDisplayLabelArray = new Array("Name", "Email", "Subject", "Category");
...
function zsValidateMandatoryFields() {
    ...
    if (isError == 0) {
        document.getElementById('zsSubmitButton_120349000004451166').setAttribute('disabled', 'disabled');
    }
}
var ZSEncoder = {
...
jQuery(document).off('click.cAtm').on('click.cAtm', '.zscloudAttachment',  () => {
...
jQuery(document).off('click.fba').on('click.fba', '.zsfilebrowseAttachment',  () => {
...
document.addEventListener('readystatechange',  () => {
    ...
    if(document.getElementById('zsSubmitButton_120349000004451166')) {
      document.getElementById('zsSubmitButton_120349000004451166').removeAttribute('disabled');
      zsAttachedAttachmentsCount = 0;
    zsAttachmentFileBrowserIdsList = [1, 2, 3, 4, 5];
    document.forms['zsWebToCase_120349000004451166']['zsWebFormCaptchaWord'].value = '';
    jQuery('#zsFileBrowseAttachments').html('');
    jQuery.each(jQuery('input[type = file]'),  (fileIndex, fileObject) => {
    ...
    if (document.forms['zsWebToCase_120349000004451166']['zsCloudPickerAttachments'] != undefined) {
        var zsCloudAttachments = jQuery.parseJSON(document.forms['zsWebToCase_120349000004451166']['zsCloudPickerAttachments'].value);
...
function zsResetWebForm(webFormId) {
    ...
    zsCloudPickerJSON = {};
    if (document.forms['zsWebToCase_120349000004451166']['zsCloudPickerAttachments'] != undefined) {
        document.forms['zsWebToCase_120349000004451166']['zsCloudPickerAttachments'].value = JSON.stringify({});
    }
    zsRearrangeFileBrowseAttachments();
    zsChangeMousePointer();
}
